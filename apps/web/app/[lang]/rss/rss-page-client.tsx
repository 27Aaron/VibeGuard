...
import { Rss, Copy, Check, Globe, BookOpen, Zap, ExternalLink } from "lucide-react"
...
export function RssPageClient({ lang, zhFeedUrl, enFeedUrl }: RssPageClientProps) {
  ...
  return (
    <div className="flex flex-col gap-3 rounded-[1.4rem] border border-black/5 bg-white/50 p-4 shadow-[inset_0_1px_0_rgba(255,255,255,0.72)] dark:border-white/10 dark:bg-white/[0.04] dark:shadow-none">
      <div className="flex items-center gap-2.5">
        ...
        <h3 className="text-sm font-semibold text-zinc-950 dark:text-stone-100">{title}</h3>
        ...
        <div className="flex shrink-0 items-center gap-1">
          ...
          <button
            ...
            className={cn(
              ...
              copied && "border-emerald-900/15 bg-emerald-50 text-emerald-800 dark:border-emerald-200/20 dark:bg-emerald-900/20 dark:text-emerald-200"
            )}
