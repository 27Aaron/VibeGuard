            ...
            <CardContent className="px-5 pb-5">
              <div className="rounded-[1.25rem] border border-black/5 bg-white/62 p-4 shadow-[inset_0_1px_0_rgba(255,255,255,0.72)] dark:border-white/10 dark:bg-white/[0.04] dark:shadow-none">
                <MarkdownSummary
                  content={
                    localized.summary ||
                    (resolvedLang === "zh" ? "摘要暂未生成。" : "Summary not generated yet.")
                  }
                      ...
                      <div className="min-w-0 flex-1">
                        <button
                          ...
                          className={cn(
                            ...
                            option.target === "full" &&
                              "border-emerald-900/18 bg-[#dfe9e2] text-emerald-950 hover:bg-[#d6e4da] hover:text-emerald-950 dark:border-emerald-200/14 dark:bg-[#121b17] dark:text-emerald-100 dark:hover:bg-[#16221c] dark:hover:text-emerald-50",
                          )}
                        >
                          {option.label}
                        </button>
