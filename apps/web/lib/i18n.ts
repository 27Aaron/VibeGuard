...
export const uiText = {
  zh: {
    ...
    publicCheckNoFindings: "当前没有查到已知风险信号。",
    publicCheckPackageName: "包名",
    publicCheckVersion: "版本",
    publicCheckVersionHint: "可选，填写后会返回更精确的命中结果。",
    ...
    publicCheckFootnote: "仅检查本地 OSV 镜像结果",
  ...
  en: {
    ...
    publicCheckTitle: "Package check",
    publicCheckDescription:
      "Pick an ecosystem and package name to query. Adding a version returns a more precise match result.",
    ...
    publicCheckNoFindings: "No known risk signals were found for the current package.",
    publicCheckPackageName: "Package",
    publicCheckVersion: "Version",
    publicCheckVersionHint: "Optional. Add a version to get a more precise match result.",
    ...
    publicCheckFootnote: "Checks only the local OSV mirror",
